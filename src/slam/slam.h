...
typedef unsigned int GLhandleARB;
    ...
    constexpr GLenum GL_NUM_SPIR_V_EXTENSIONS                    = 0x9554;
     ...
     extern void  (APIENTRY *glClearNamedFramebufferfi) (GLuint  framebuffer, GLenum  buffer, GLint  drawbuffer, GLfloat  depth, GLint  stencil);
     ...
     extern void  (APIENTRY *glMultiDrawArraysIndirectCount) (GLenum  mode, const void * indirect, GLintptr  drawcount, GLsizei  maxdrawcount, GLsizei  stride);
     ...
     extern void  (APIENTRY *glMultiDrawElementsIndirectCount) (GLenum  mode, GLenum  type, const void * indirect, GLintptr  drawcount, GLsizei  maxdrawcount, GLsizei  stride);
     ...
     extern void  (APIENTRY *glPolygonOffsetClamp) (GLfloat  factor, GLfloat  units, GLfloat  clamp);
     ...
     extern void  (APIENTRY *glSpecializeShader) (GLuint  shader, const GLchar * pEntryPoint, GLuint  numSpecializationConstants, const GLuint * pConstantIndex, const GLuint * pConstantValue);
